...
void EnBa_Idle(EnBa* this, PlayState* play) {
    ...
    if (!(player->stateFlags1 & PLAYER_STATE1_KNOCKBACK_FROZEN) && (this->actor.xzDistToPlayer <= 175.0f) &&
        (this->actor.world.pos.y == this->actor.home.pos.y + 100.0f)) {
    ...
    if ((this->actor.xzDistToPlayer <= 175.0f) || (this->unk_31A != 0)) {
        ...
        if (this->unk_318 != 0) {
            ...
            if (this->unk_31A != 0) {
                ...
                this->unk_31A--;
            } else if ((this->actor.xzDistToPlayer > 175.0f) || (player->stateFlags1 & PLAYER_STATE1_KNOCKBACK_FROZEN)) {
                EnBa_SetupIdle(this);
            } else {
                EnBa_SetupSwingAtPlayer(this);
                this->unk_318 = 27;
